  ...
  return (
    <>
      ...
      <div className='py-24 px-5 sm:px-10 md:px-16 lg:px-24 xl:px-36 2xl:px-44 flex flex-col w-full gap-5 justify-center items-center'>
        <h1 className='text-2xl text-slate-800 font-black'>Add New Car</h1>
        <form className='flex flex-col gap-5 w-full md:w-1/2 md:border md:p-10 md:shadow-lg' onSubmit={createCar}>
          ...
          {operator.image_id && <div className='w-full'>
            <UploadButton
              endpoint="carImage"
          ...
          {operator.image_id ? <button disabled={isLoading} className={`${isLoading ? 'bg-red-500' : 'bg-red-700 hover:bg-red-500'} text-lg text-white py-2 px-10 self-center rounded-3xl`}>
