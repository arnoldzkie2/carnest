    ...
    <footer className='px-5 sm:px-10 md:px-16 py-5 lg:py-10 lg:px-24 xl:px-36 2xl:px-44 gap-5 flex flex-col items-center text-gray-600 bg-slate-50'>
      ...
      <nav className='flex md:justify-between flex-col gap-7 lg:gap-0 md:flex-row w-full'>
        ...
        <ul className='flex items-center gap-4 md:gap-3 md:flex-col md:items-start'>
          ...
          <li>
            <Link href='/operator/transactions' className='text-sm lg:text-base hover:text-red-600 cursor-pointer' >Transactions</Link>
          </li>
          <li>
            <div onClick={() => {
              localStorage.clear()
              router.push('/signup/user')
            }} className='text-sm lg:text-base hover:text-red-600 cursor-pointer' >Sign Up as User</div>
          </li>
          <li>
            <div onClick={() => {
              localStorage.clear()
              router.push('/login/user')
            }} className='text-sm lg:text-base hover:text-red-600 cursor-pointer' >Login as User</div>
          </li>
          <li>
